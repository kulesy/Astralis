...
class Game:
    ...
    def redraw_window(self):
        display.blit(BG, (0,0))
        # Draw text
        level_label = self.small_font.render(f"Level: {self.level}", display, (WIDTH - self.small_font.width(f"Level: {self.level}") - 10, 10))
        score_label = self.small_font.render(f"Score: {self.player.score}", display, (10, 10))
